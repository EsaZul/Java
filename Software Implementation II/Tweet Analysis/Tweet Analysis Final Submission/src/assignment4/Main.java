...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Filter by Timespan
        Instant testStart = Instant.parse("2017-11-11T00:00:00Z");            //"2017-11-11T00:00:00Z"
        Instant testEnd = Instant.parse("2017-11-12T12:00:00Z");             //"2017-11-12T12:00:00Z"
        ...
        List<Set<String>> clique = SocialNetwork.findCliques(tweetsList);
